...
(
    ...
    stored as orc 
    location '/datahouse/dws/dws_trade_user_sku_order_1d'
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_sku_order_refund_1d'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_order_1d'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_cart_add_1d'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_payment_1d'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_order_refund_1d'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_province_order_1d'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_traffic_session_page_view_1d'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_traffic_page_visitor_page_view_1d'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_sku_order_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_sku_order_refund_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_order_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_cart_add_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_payment_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_order_refund_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_province_order_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_coupon_order_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_activity_order_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_traffic_page_visitor_page_view_nd'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_order_td'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_trade_user_payment_td'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dws/dws_user_user_login_td'
    tblproperties ('orc.compress' = 'snappy');
