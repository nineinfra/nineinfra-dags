...
(
    ...
    stored as orc
    location '/datahouse/dwd/dwd_trade_cart_add_inc/'
...
(
    ...
    row format delimited fields terminated by '\t' 
    stored as orc 
    location '/datahouse/dwd/dwd_trade_order_detail_inc/'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    row format delimited fields terminated by '\t' 
    stored as orc 
    location '/datahouse/dwd/dwd_trade_cancel_detail_inc/'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    row format delimited fields terminated by '\t' 
    stored as orc 
    location '/datahouse/dwd/dwd_trade_pay_detail_suc_inc/'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_trade_order_refund_inc/'
    tblproperties ("orc.compress" = "snappy");
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_trade_refund_pay_suc_inc/'
    tblproperties ("orc.compress" = "snappy");
...
(
    ...
    row format delimited fields terminated by '\t' 
    stored as orc 
    location '/datahouse/dwd/dwd_trade_cart_full/'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_tool_coupon_get_inc/'
    tblproperties ("orc.compress" = "snappy");
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_tool_coupon_order_inc/'
    tblproperties ("orc.compress" = "snappy");
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_tool_coupon_pay_inc/'
    tblproperties ("orc.compress" = "snappy");
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_interaction_favor_add_inc/'
    tblproperties ("orc.compress" = "snappy");
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_interaction_comment_inc/'
    tblproperties ("orc.compress" = "snappy");
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_traffic_page_view_inc'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_traffic_start_inc'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_traffic_action_inc'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_traffic_display_inc'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_traffic_error_inc'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_user_register_inc/'
    tblproperties ("orc.compress" = "snappy");
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dwd/dwd_user_login_inc/'
    tblproperties ("orc.compress" = "snappy");
