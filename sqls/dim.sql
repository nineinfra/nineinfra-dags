...
(
    ...
    stored as orc 
    location '/datahouse/dim/dim_sku_full/'
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dim/dim_coupon_full/'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dim/dim_activity_full/'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dim/dim_province_full/'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    stored as orc 
    location '/datahouse/dim/dim_date/'
    tblproperties ('orc.compress' = 'snappy');
...
(
    ...
    location '/datahouse/tmp/tmp_dim_date_info/';
...
(
    ...
    partitioned by (dt string) 
    stored as orc 
    location '/datahouse/dim/dim_user_zip/'
    tblproperties ('orc.compress' = 'snappy');
