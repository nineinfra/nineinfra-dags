--drop datahouse if exists datahouse;
...
--    location '/datahouse/ods/ods_log_inc/';
...
--    location '/datahouse/ods/ods_activity_info_full/';
...
(
    ...
    partitioned by (dt string)
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_activity_rule_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_base_category1_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_base_category2_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_base_category3_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_base_dic_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_base_province_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_base_region_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_base_trademark_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_cart_info_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_coupon_info_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_sku_attr_value_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_sku_info_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_sku_sale_attr_value_full/';
...
(
    ...
    partitioned by (dt string) 
    row format delimited fields terminated by '\t' null defined as '';
--    location '/datahouse/ods/ods_spu_info_full/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_cart_info_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_comment_info_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_coupon_use_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_favor_info_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_order_detail_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_order_detail_activity_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_order_detail_coupon_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_order_info_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_order_refund_info_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_order_status_log_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_payment_info_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_refund_payment_inc/';
...
(
    ...
    partitioned by (dt string) 
    row format serde 'org.apache.hive.hcatalog.data.JsonSerDe';
--    location '/datahouse/ods/ods_user_info_inc/';
