def get_ods2dim_init_sqls(datahouse_dir, data_base, start_date):
    dim_date = f"\
    ...
    dim_init_sqls = [dim_date, dim_user_zip, dim_sku_full, dim_province_full, dim_coupon_full, dim_activity_full]
    return dim_init_sqls
